...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/fr.search-data.min.f982d9f3dc3c9330a6ba93db73f3ae163529f38af596de1337c412b4d2f4e8fa.js',function(){input.required=false;search();});}
