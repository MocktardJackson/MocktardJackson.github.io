...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/fr.search-data.min.d5eb46bf862559b9d3ac215fbd607c5fccec78be5ff1c685dcff4308fbe3a88f.js',function(){input.required=false;search();});}
