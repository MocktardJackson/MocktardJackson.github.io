...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/fr.search-data.min.0801c5d3974dc4cb8d4db69a66a9b7cfd1af432ae254db5f275b9ccca683624e.js',function(){input.required=false;search();});}
