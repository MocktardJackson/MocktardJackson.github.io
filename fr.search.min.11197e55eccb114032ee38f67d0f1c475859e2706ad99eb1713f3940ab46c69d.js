...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/fr.search-data.min.2a40a1cd024d64024c97cbff2a0ffde06f1a8f01bbf65ae226c4791f37e98063.js',function(){input.required=false;search();});}
